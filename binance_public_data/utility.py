...
def get_parser(parser_type):
    ...
    parser.add_argument(
        ...
        nargs="+",
        choices=YEARS,
        help=f"Single year or multiple years separated by space\n-y 2019 2021 means to download {parser_type} from 2019 and 2021",
    )
    parser.add_argument(
        "-m",
        dest="months",
        ...
        type=int,
        choices=MONTHS,
        help=f"Single month or multiple months separated by space\n-m 2 12 means to download {parser_type} from feb and dec",
    )
    parser.add_argument(
        "-d",
        dest="dates",
    ...
    parser.add_argument(
        ...
        help=f"Valid trading types: {TRADING_TYPE}",
    )
